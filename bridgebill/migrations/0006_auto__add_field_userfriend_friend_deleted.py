...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserFriend.friend_deleted'
        db.add_column('bridgebill_userfriend', 'friend_deleted',
                      self.gf('django.db.models.fields.CharField')(default='N', max_length=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserFriend.friend_deleted'
        db.delete_column('bridgebill_userfriend', 'friend_deleted')
    ...
    models = {
        ...
        'bridgebill.bill': {
            ...
            'currency': ('django.db.models.fields.CharField', [], {'default': "'SGD'", 'max_length': '30'}),
        ...
        'bridgebill.userfriend': {
            ...
            'friend_deleted': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
