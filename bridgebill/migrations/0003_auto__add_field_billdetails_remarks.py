...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BillDetails.remarks'
        db.add_column('bridgebill_billdetails', 'remarks',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=300, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BillDetails.remarks'
        db.delete_column('bridgebill_billdetails', 'remarks')
