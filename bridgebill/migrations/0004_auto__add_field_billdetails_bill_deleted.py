...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BillDetails.bill_deleted'
        db.add_column('bridgebill_billdetails', 'bill_deleted',
                      self.gf('django.db.models.fields.CharField')(default='N', max_length=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BillDetails.bill_deleted'
        db.delete_column('bridgebill_billdetails', 'bill_deleted')
