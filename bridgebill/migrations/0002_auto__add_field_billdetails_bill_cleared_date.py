...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BillDetails.bill_cleared_date'
        db.add_column('bridgebill_billdetails', 'bill_cleared_date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 2, 9, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BillDetails.bill_cleared_date'
        db.delete_column('bridgebill_billdetails', 'bill_cleared_date')
